...
export default function FireBrigadeSimulationPage() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (d.vehicleType !== 'fire-brigade') router.push('/emergency-response/sign-in')
    } catch {
      router.push('/emergency-response/sign-in')
    }
  }, [router])
  ...
  return (
    <div className="fixed inset-0 z-50 bg-[#0B1220]">
      <EmergencyDashboard defaultRole="emergency-fire" />
    </div>
  )
}
