...
//       // 2. State Overrides (Ambulance & Dormant Wakes)
//       if (ambDir) {
...
//           // BUG FIX: The active ambulance has cleared, but another ambulance is waiting in a different direction.
//           // Safely transition through a Yellow phase before giving the new ambulance the Green light.
//           nextState.mode = 'Preempting';
//           nextState.timer = YELLOW_DURATION;
//           nextState.nextDir = ambDir;
//         }
//       } else if (nextState.mode === 'Ambulance') {
//          // No ambulances left on the entire board. Return to normal operations.
...
//     return (
//       <div className="flex flex-col gap-3 p-4 bg-zinc-900/80 border border-zinc-700 rounded-xl w-45 shadow-2xl">
//         <div className="text-zinc-400 font-mono text-xs uppercase tracking-widest border-b border-zinc-700 pb-2">Dir {dir} Entry</div>
//         <button 
//           onClick={() => dispatch({ type: 'ADD_VEHICLE', dir, vType: 1 })} 
//           className="hover:bg-zinc-700 active:bg-cyan-900 text-[#669DF6] text-sm py-2 border border-[#669DF6] rounded shadow transition-colors"
//         >
//           <div className="flex gap-2 items-center justify-center">
//             <FaPlusSquare className="w-4 h-4"></FaPlusSquare>
//             <p className="font-medium">Add Car</p>
//           </div>
//         </button>
//         <button 
//           onClick={() => dispatch({ type: 'ADD_VEHICLE', dir, vType: 2 })} 
//           className="hover:bg-red-900/70 active:bg-red-800 text-red-400 border border-red-400 text-sm py-2 rounded shadow transition-colors"
//         >
//           <div className="flex gap-2 items-center justify-center">
//             <FaPlusSquare className="w-4 h-4"></FaPlusSquare>
...
//           disabled={isEmpty}
//           className={`text-sm py-1.5 rounded shadow transition-colors border ${isEmpty ? 'text-[#e8eaed61] bord cursor-not-allowed' : 'hover:bg-zinc-800 text-[#669DF6]'}`}
//         >
//           <div className="flex gap-2 items-center justify-center">
...
//             <div className="flex-1 border-r-2 border-dashed border-zinc-700 flex flex-col justify-end items-center gap-2 pb-4">
...
//              <div className="flex-1 border-r-2 border-dashed border-zinc-700 flex flex-col justify-start items-center gap-2 pt-4">
...
//             <div className="flex-1 border-b-2 border-dashed border-zinc-700 flex justify-end items-center gap-2 pr-4">
...
//              <div className="flex-1 border-b-2 border-dashed border-zinc-700 flex justify-start items-center gap-2 pl-4">
...
//           <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-44 h-44 bg-zinc-950 border-4 border-dashed border-yellow-600/30 flex items-center justify-center z-0 rounded-lg">
//             <div className="text-zinc-800 font-black text-6xl opacity-20 select-none">✕</div>
//           </div>

//           {renderLight(1, "top-[90px] left-[450px]")}
//           {renderLight(2, "top-[450px] left-[450px]")}
//           {renderLight(3, "top-[450px] left-[185px]")}
