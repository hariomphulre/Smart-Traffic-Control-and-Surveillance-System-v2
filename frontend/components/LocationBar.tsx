...
export default function LocationBar() {
  ...
  return (
    <div className="w-full relative font-sans z-100" ref={wrapperRef}>
      {/* TOP LOCATION BAR */}
      <div className="relative z-10 flex w-full border-b border-[#3c4043] h-8 bg-black mb-0 items-center justify-between">
