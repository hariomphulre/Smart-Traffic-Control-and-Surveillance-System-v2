-- Demo seed data for local Docker Postgres
...
INSERT INTO vehicle_logs (license_no, vehicle_type, location, speed, helmet_status, red_light_cross, tripling, detected_at)
VALUES
...
VALUES
  ('accident_1_1771581117', 'MG Road Junction',       '2-vehicle high severity collision.', 'high',   TRUE,  NOW()-INTERVAL '2 days'),
  ('accident_2_1771596629', 'NH-8 Toll Plaza',        'Minor rear-end collision.', 'low',    FALSE, NOW()-INTERVAL '4 days'),
  ('accident_3_1771596642', 'Airport Road',           'Medium severity bus/car collision.', 'medium', TRUE,  NOW()-INTERVAL '6 days'),
  ('accident_4_1771648024', 'Sadar Bazaar',           'Bike skid accident.', 'medium', TRUE,  NOW()-INTERVAL '8 days'),
  ('accident_5_1771648048', 'Industrial Area Gate 4', 'Fire in truck cabin.', 'high',   TRUE,  NOW()-INTERVAL '10 days')
ON CONFLICT (accident_id) DO NOTHING;

INSERT INTO accident_vehicles (accident_id, license_no, vehicle_type, speed)
VALUES
  ('accident_1_1771581117', 'DL-01-AB-1234', 'Car',   65),
  ('accident_1_1771581117', 'UP-32-KL-2345', 'Car',   58),
  ('accident_2_1771596629', 'KA-03-EF-9012', 'Truck', 70),
  ('accident_3_1771596642', 'TN-07-GH-3456', 'Bus',   55),
  ('accident_3_1771596642', 'MP-09-OP-1234', 'Car',   48),
  ('accident_4_1771648024', 'RJ-14-MN-6789', 'Bike',  40),
  ('accident_5_1771648048', 'HR-26-ST-9012', 'Truck', 80);

INSERT INTO vehicle_images (log_id, license_no, vehicle_type, image_path, license_plate_path, captured_at)
VALUES
  (1,  'DL-01-AB-1234', 'Car',   '/uploads/all_vehicle_detected_img/vehicle_1.jpg',  '/uploads/all_license_plate_img/license_plate_1.jpg',  NOW()-INTERVAL '1 hour'),
  (2,  'MH-12-CD-5678', 'Bike',  '/uploads/all_vehicle_detected_img/vehicle_2.jpg',  '/uploads/all_license_plate_img/license_plate_2.jpg',  NOW()-INTERVAL '2 hours'),
  (3,  'KA-03-EF-9012', 'Truck', '/uploads/all_vehicle_detected_img/vehicle_3.jpg',  '/uploads/all_license_plate_img/license_plate_3.jpg',  NOW()-INTERVAL '3 hours'),
  (4,  'TN-07-GH-3456', 'Bus',   '/uploads/all_vehicle_detected_img/vehicle_4.jpg',  '/uploads/all_license_plate_img/license_plate_4.jpg',  NOW()-INTERVAL '4 hours'),
  (5,  'GJ-05-IJ-7890', 'Auto',  '/uploads/all_vehicle_detected_img/vehicle_5.jpg',  '/uploads/all_license_plate_img/license_plate_5.jpg',  NOW()-INTERVAL '5 hours'),
  (6,  'UP-32-KL-2345', 'Car',   '/uploads/all_vehicle_detected_img/vehicle_6.jpg',  '/uploads/all_license_plate_img/license_plate_6.jpg',  NOW()-INTERVAL '6 hours'),
  (7,  'RJ-14-MN-6789', 'Bike',  '/uploads/all_vehicle_detected_img/vehicle_7.jpg',  '/uploads/all_license_plate_img/license_plate_7.jpg',  NOW()-INTERVAL '7 hours'),
  (8,  'MP-09-OP-1234', 'Car',   '/uploads/all_vehicle_detected_img/vehicle_8.jpg',  '/uploads/all_license_plate_img/license_plate_8.jpg',  NOW()-INTERVAL '8 hours'),
  (9,  'PB-10-QR-5678', 'Bike',  '/uploads/all_vehicle_detected_img/vehicle_9.jpg',  '/uploads/all_license_plate_img/license_plate_9.jpg',  NOW()-INTERVAL '9 hours'),
  (10, 'HR-26-ST-9012', 'Truck', '/uploads/all_vehicle_detected_img/vehicle_10.jpg', '/uploads/all_license_plate_img/license_plate_10.jpg', NOW()-INTERVAL '10 hours');

INSERT INTO accident_media (accident_id, location, media_type, file_path, duration, severity, recorded_at)
VALUES
  ('accident_1_1771581117', 'MG Road Junction',       'video', '/recordings/accident_1.mp4',        '60s',  'high',   NOW()-INTERVAL '2 days'),
  ('accident_1_1771581117', 'MG Road Junction',       'image', '/recordings/accident_1_scene.jpg',  NULL,   'high',   NOW()-INTERVAL '2 days'),
  ('accident_2_1771596629', 'NH-8 Toll Plaza',        'image', '/recordings/accident_2.jpg',        NULL,   'low',    NOW()-INTERVAL '4 days'),
  ('accident_3_1771596642', 'Airport Road',           'video', '/recordings/accident_3.mp4',        '45s',  'medium', NOW()-INTERVAL '6 days'),
  ('accident_4_1771648024', 'Sadar Bazaar',           'video', '/recordings/accident_4.mp4',        '30s',  'medium', NOW()-INTERVAL '8 days'),
  ('accident_5_1771648048', 'Industrial Area Gate 4', 'video', '/recordings/accident_5_fire.mp4',   '120s', 'high',   NOW()-INTERVAL '10 days');
