...
# ============================================================================
DEFAULT_MODEL = "new_car4_with_helmet.pt"        # Your main detection model
DEFAULT_SOURCE = "demo_src_acc1.mp4"                # Video file, image, folder, or "usb0" for webcam
...
DEFAULT_ACCIDENT_MODEL = "new_accident_1.pt"     # Accident detection model
