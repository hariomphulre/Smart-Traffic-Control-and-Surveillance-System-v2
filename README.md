...
🌐 Web platform:   [smart-traffic-control.vercel.app/](https://smart-traffic-control.vercel.app/)  ![Build Status](https://img.shields.io/github/actions/workflow/status/owner/repo/ci.yml?branch=main)
