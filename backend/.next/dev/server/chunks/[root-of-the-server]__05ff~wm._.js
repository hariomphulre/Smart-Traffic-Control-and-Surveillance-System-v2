    ...
    static async getAll(query) {
        ...
        return {
            data: dataResult.rows.map((r)=>({
                    ...
                    paymentDate: r.challan_status === 'received' ? r.payment_date instanceof Date ? r.payment_date.toISOString() : r.payment_date : null
                })),
...
"[project]/app/api/challans/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
